...
#include "tetgen.h"            // Defines the symbol REAL_tetgen_t (float or double).
...
/* #define REAL_tetgen_t double */                      /* float or double */
...
#define Split(a, ahi, alo) \
  c = (REAL_tetgen_t) (splitter * a); \
  abig = (REAL_tetgen_t) (c - a); \
  ahi = c - abig; \
  alo = a - ahi
...
static REAL_tetgen_t splitter;
static REAL_tetgen_t epsilon;         /* = 2^(-p).  Used to estimate roundoff errors. */
/* A set of coefficients used to calculate maximum roundoff errors.          */
static REAL_tetgen_t resulterrbound;
static REAL_tetgen_t ccwerrboundA, ccwerrboundB, ccwerrboundC;
static REAL_tetgen_t o3derrboundA, o3derrboundB, o3derrboundC;
static REAL_tetgen_t iccerrboundA, iccerrboundB, iccerrboundC;
static REAL_tetgen_t isperrboundA, isperrboundB, isperrboundC;
...
// Added by H. Si, 2012-08-23.
static REAL_tetgen_t o3dstaticfilter;
static REAL_tetgen_t ispstaticfilter;
...
void exactinit(int verbose, int noexact, int nofilter, REAL_tetgen_t maxx, REAL_tetgen_t maxy, 
               REAL_tetgen_t maxz)
{
  REAL_tetgen_t half;
  REAL_tetgen_t check, lastcheck;
  int every_other;
#ifdef LINUX
  int cword;
#endif /* LINUX */
...
int grow_expansion(int elen, REAL_tetgen_t *e, REAL_tetgen_t b, REAL_tetgen_t *h)
/* e and h can be the same. */
{
  REAL_tetgen_t Q;
  INEXACT REAL_tetgen_t Qnew;
  int eindex;
  REAL_tetgen_t enow;
  INEXACT REAL_tetgen_t bvirt;
  REAL_tetgen_t avirt, bround, around;
...
int grow_expansion_zeroelim(int elen, REAL_tetgen_t *e, REAL_tetgen_t b, REAL_tetgen_t *h)
/* e and h can be the same. */
{
  REAL_tetgen_t Q, hh;
  INEXACT REAL_tetgen_t Qnew;
...
int expansion_sum(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f, REAL_tetgen_t *h)
...
int expansion_sum_zeroelim1(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f, REAL_tetgen_t *h)
/* e and h can be the same, but f and h cannot. */
{
  REAL_tetgen_t Q;
  INEXACT REAL_tetgen_t Qnew;
...
int expansion_sum_zeroelim2(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f, REAL_tetgen_t *h)
/* e and h can be the same, but f and h cannot. */
{
  REAL_tetgen_t Q, hh;
  INEXACT REAL_tetgen_t Qnew;
...
int fast_expansion_sum(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f, REAL_tetgen_t *h)
/* h cannot be e or f. */
{
  REAL_tetgen_t Q;
  INEXACT REAL_tetgen_t Qnew;
...
int fast_expansion_sum_zeroelim(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f, REAL_tetgen_t *h)
/* h cannot be e or f. */
{
  REAL_tetgen_t Q;
  INEXACT REAL_tetgen_t Qnew;
  INEXACT REAL_tetgen_t hh;
  INEXACT REAL_tetgen_t bvirt;
  REAL_tetgen_t avirt, bround, around;
  int eindex, findex, hindex;
  REAL_tetgen_t enow, fnow;
...
int linear_expansion_sum(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f, REAL_tetgen_t *h)
/* h cannot be e or f. */
{
  REAL_tetgen_t Q, q;
  INEXACT REAL_tetgen_t Qnew;
  INEXACT REAL_tetgen_t R;
  INEXACT REAL_tetgen_t bvirt;
  REAL_tetgen_t avirt, bround, around;
  int eindex, findex, hindex;
  REAL_tetgen_t enow, fnow;
...
int linear_expansion_sum_zeroelim(int elen, REAL_tetgen_t *e, int flen, REAL_tetgen_t *f,
                                  REAL_tetgen_t *h)
/* h cannot be e or f. */
{
  REAL_tetgen_t Q, q, hh;
  INEXACT REAL_tetgen_t Qnew;
  INEXACT REAL_tetgen_t R;
  INEXACT REAL_tetgen_t bvirt;
  REAL_tetgen_t avirt, bround, around;
...
int scale_expansion(int elen, REAL_tetgen_t *e, REAL_tetgen_t b, REAL_tetgen_t *h)
/* e and h cannot be the same. */
{
  INEXACT REAL_tetgen_t Q;
  INEXACT REAL_tetgen_t sum;
  INEXACT REAL_tetgen_t product1;
  REAL_tetgen_t product0;
  int eindex, hindex;
  REAL_tetgen_t enow;
  INEXACT REAL_tetgen_t bvirt;
  REAL_tetgen_t avirt, bround, around;
  INEXACT REAL_tetgen_t c;
  INEXACT REAL_tetgen_t abig;
  REAL_tetgen_t ahi, alo, bhi, blo;
  REAL_tetgen_t err1, err2, err3;
...
int scale_expansion_zeroelim(int elen, REAL_tetgen_t *e, REAL_tetgen_t b, REAL_tetgen_t *h)
/* e and h cannot be the same. */
{
  INEXACT REAL_tetgen_t Q, sum;
  REAL_tetgen_t hh;
  INEXACT REAL_tetgen_t product1;
  REAL_tetgen_t product0;
  int eindex, hindex;
...
int compress(int elen, REAL_tetgen_t *e, REAL_tetgen_t *h)
...
REAL_tetgen_t estimate(int elen, REAL_tetgen_t *e)
{
  REAL_tetgen_t Q;
  int eindex;
...
REAL_tetgen_t orient2dfast(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc)
{
  REAL_tetgen_t acx, bcx, acy, bcy;
...
REAL_tetgen_t orient2dexact(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc)
{
  INEXACT REAL_tetgen_t axby1, axcy1, bxcy1, bxay1, cxay1, cxby1;
  REAL_tetgen_t axby0, axcy0, bxcy0, bxay0, cxay0, cxby0;
  REAL_tetgen_t aterms[4], bterms[4], cterms[4];
  INEXACT REAL_tetgen_t aterms3, bterms3, cterms3;
  REAL_tetgen_t v[8], w[12];
  int vlength, wlength;
...
REAL_tetgen_t orient2dslow(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc)
{
  INEXACT REAL_tetgen_t acx, acy, bcx, bcy;
  REAL_tetgen_t acxtail, acytail;
  REAL_tetgen_t bcxtail, bcytail;
  REAL_tetgen_t negate, negatetail;
  REAL_tetgen_t axby[8], bxay[8];
  INEXACT REAL_tetgen_t axby7, bxay7;
  REAL_tetgen_t deter[16];
  int deterlen;
  ...
  INEXACT REAL_tetgen_t c;
  INEXACT REAL_tetgen_t abig;
  REAL_tetgen_t a0hi, a0lo, a1hi, a1lo, bhi, blo;
  REAL_tetgen_t err1, err2, err3;
  INEXACT REAL_tetgen_t _i, _j, _k, _l, _m, _n;
  REAL_tetgen_t _0, _1, _2;
...
REAL_tetgen_t orient2dadapt(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t detsum)
{
  INEXACT REAL_tetgen_t acx, acy, bcx, bcy;
  REAL_tetgen_t acxtail, acytail, bcxtail, bcytail;
  INEXACT REAL_tetgen_t detleft, detright;
  REAL_tetgen_t detlefttail, detrighttail;
  REAL_tetgen_t det, errbound;
  REAL_tetgen_t B[4], C1[8], C2[12], D[16];
  INEXACT REAL_tetgen_t B3;
  int C1length, C2length, Dlength;
  REAL_tetgen_t u[4];
  INEXACT REAL_tetgen_t u3;
  INEXACT REAL_tetgen_t s1, t1;
  REAL_tetgen_t s0, t0;
  ...
  acx = (REAL_tetgen_t) (pa[0] - pc[0]);
  bcx = (REAL_tetgen_t) (pb[0] - pc[0]);
  acy = (REAL_tetgen_t) (pa[1] - pc[1]);
  bcy = (REAL_tetgen_t) (pb[1] - pc[1]);
...
REAL_tetgen_t orient2d(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc)
{
  REAL_tetgen_t detleft, detright, det;
  REAL_tetgen_t detsum, errbound;
...
REAL_tetgen_t orient3dfast(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  REAL_tetgen_t adx, bdx, cdx;
  REAL_tetgen_t ady, bdy, cdy;
  REAL_tetgen_t adz, bdz, cdz;
...
REAL_tetgen_t orient3dexact(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  INEXACT REAL_tetgen_t axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
  INEXACT REAL_tetgen_t bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
  REAL_tetgen_t axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
  REAL_tetgen_t bxay0, cxby0, dxcy0, axdy0, cxay0, dxby0;
  REAL_tetgen_t ab[4], bc[4], cd[4], da[4], ac[4], bd[4];
  REAL_tetgen_t temp8[8];
  int templen;
  REAL_tetgen_t abc[12], bcd[12], cda[12], dab[12];
  int abclen, bcdlen, cdalen, dablen;
  REAL_tetgen_t adet[24], bdet[24], cdet[24], ddet[24];
  int alen, blen, clen, dlen;
  REAL_tetgen_t abdet[48], cddet[48];
  int ablen, cdlen;
  REAL_tetgen_t deter[96];
  int deterlen;
  int i;
...
REAL_tetgen_t orient3dslow(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  INEXACT REAL_tetgen_t adx, ady, adz, bdx, bdy, bdz, cdx, cdy, cdz;
  REAL_tetgen_t adxtail, adytail, adztail;
  REAL_tetgen_t bdxtail, bdytail, bdztail;
  REAL_tetgen_t cdxtail, cdytail, cdztail;
  REAL_tetgen_t negate, negatetail;
  INEXACT REAL_tetgen_t axby7, bxcy7, axcy7, bxay7, cxby7, cxay7;
  REAL_tetgen_t axby[8], bxcy[8], axcy[8], bxay[8], cxby[8], cxay[8];
  REAL_tetgen_t temp16[16], temp32[32], temp32t[32];
  int temp16len, temp32len, temp32tlen;
  REAL_tetgen_t adet[64], bdet[64], cdet[64];
  int alen, blen, clen;
  REAL_tetgen_t abdet[128];
  int ablen;
  REAL_tetgen_t deter[192];
  int deterlen;
...
REAL_tetgen_t orient3dadapt(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t permanent)
{
  INEXACT REAL_tetgen_t adx, bdx, cdx, ady, bdy, cdy, adz, bdz, cdz;
  REAL_tetgen_t det, errbound;

  INEXACT REAL_tetgen_t bdxcdy1, cdxbdy1, cdxady1, adxcdy1, adxbdy1, bdxady1;
  REAL_tetgen_t bdxcdy0, cdxbdy0, cdxady0, adxcdy0, adxbdy0, bdxady0;
  REAL_tetgen_t bc[4], ca[4], ab[4];
  INEXACT REAL_tetgen_t bc3, ca3, ab3;
  REAL_tetgen_t adet[8], bdet[8], cdet[8];
  int alen, blen, clen;
  REAL_tetgen_t abdet[16];
  int ablen;
  REAL_tetgen_t *finnow, *finother, *finswap;
  REAL_tetgen_t fin1[192], fin2[192];
  int finlength;


  REAL_tetgen_t adxtail, bdxtail, cdxtail;
  REAL_tetgen_t adytail, bdytail, cdytail;
  REAL_tetgen_t adztail, bdztail, cdztail;
  INEXACT REAL_tetgen_t at_blarge, at_clarge;
  INEXACT REAL_tetgen_t bt_clarge, bt_alarge;
  INEXACT REAL_tetgen_t ct_alarge, ct_blarge;
  REAL_tetgen_t at_b[4], at_c[4], bt_c[4], bt_a[4], ct_a[4], ct_b[4];
  int at_blen, at_clen, bt_clen, bt_alen, ct_alen, ct_blen;
  INEXACT REAL_tetgen_t bdxt_cdy1, cdxt_bdy1, cdxt_ady1;
  INEXACT REAL_tetgen_t adxt_cdy1, adxt_bdy1, bdxt_ady1;
  REAL_tetgen_t bdxt_cdy0, cdxt_bdy0, cdxt_ady0;
  REAL_tetgen_t adxt_cdy0, adxt_bdy0, bdxt_ady0;
  INEXACT REAL_tetgen_t bdyt_cdx1, cdyt_bdx1, cdyt_adx1;
  INEXACT REAL_tetgen_t adyt_cdx1, adyt_bdx1, bdyt_adx1;
  REAL_tetgen_t bdyt_cdx0, cdyt_bdx0, cdyt_adx0;
  REAL_tetgen_t adyt_cdx0, adyt_bdx0, bdyt_adx0;
  REAL_tetgen_t bct[8], cat[8], abt[8];
  int bctlen, catlen, abtlen;
  INEXACT REAL_tetgen_t bdxt_cdyt1, cdxt_bdyt1, cdxt_adyt1;
  INEXACT REAL_tetgen_t adxt_cdyt1, adxt_bdyt1, bdxt_adyt1;
  REAL_tetgen_t bdxt_cdyt0, cdxt_bdyt0, cdxt_adyt0;
  REAL_tetgen_t adxt_cdyt0, adxt_bdyt0, bdxt_adyt0;
  REAL_tetgen_t u[4], v[12], w[16];
  INEXACT REAL_tetgen_t u3;
  int vlength, wlength;
  REAL_tetgen_t negate;
  ...
  REAL_tetgen_t ahi, alo, bhi, blo;
  REAL_tetgen_t err1, err2, err3;
  INEXACT REAL_tetgen_t _i, _j, _k;
  REAL_tetgen_t _0;


  adx = (REAL_tetgen_t) (pa[0] - pd[0]);
  bdx = (REAL_tetgen_t) (pb[0] - pd[0]);
  cdx = (REAL_tetgen_t) (pc[0] - pd[0]);
  ady = (REAL_tetgen_t) (pa[1] - pd[1]);
  bdy = (REAL_tetgen_t) (pb[1] - pd[1]);
  cdy = (REAL_tetgen_t) (pc[1] - pd[1]);
  adz = (REAL_tetgen_t) (pa[2] - pd[2]);
  bdz = (REAL_tetgen_t) (pb[2] - pd[2]);
  cdz = (REAL_tetgen_t) (pc[2] - pd[2]);
...
REAL_tetgen_t orient3d(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  return (REAL_tetgen_t) 
...
REAL_tetgen_t orient3d(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  REAL_tetgen_t adx, bdx, cdx, ady, bdy, cdy, adz, bdz, cdz;
  REAL_tetgen_t bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
  REAL_tetgen_t det;
  ...
  REAL_tetgen_t permanent, errbound;
...
REAL_tetgen_t incirclefast(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  REAL_tetgen_t adx, ady, bdx, bdy, cdx, cdy;
  REAL_tetgen_t abdet, bcdet, cadet;
  REAL_tetgen_t alift, blift, clift;
...
REAL_tetgen_t incircleexact(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  INEXACT REAL_tetgen_t axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
  INEXACT REAL_tetgen_t bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
  REAL_tetgen_t axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
  ...
  REAL_tetgen_t abc[12], bcd[12], cda[12], dab[12];
  int abclen, bcdlen, cdalen, dablen;
  REAL_tetgen_t det24x[24], det24y[24], det48x[48], det48y[48];
  int xlen, ylen;
  REAL_tetgen_t adet[96], bdet[96], cdet[96], ddet[96];
  int alen, blen, clen, dlen;
  REAL_tetgen_t abdet[192], cddet[192];
  int ablen, cdlen;
  REAL_tetgen_t deter[384];
  int deterlen;
  int i;
...
REAL_tetgen_t incircleslow(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  INEXACT REAL_tetgen_t adx, bdx, cdx, ady, bdy, cdy;
  REAL_tetgen_t adxtail, bdxtail, cdxtail;
  REAL_tetgen_t adytail, bdytail, cdytail;
  REAL_tetgen_t negate, negatetail;
  INEXACT REAL_tetgen_t axby7, bxcy7, axcy7, bxay7, cxby7, cxay7;
  REAL_tetgen_t axby[8], bxcy[8], axcy[8], bxay[8], cxby[8], cxay[8];
  REAL_tetgen_t temp16[16];
  int temp16len;
  REAL_tetgen_t detx[32], detxx[64], detxt[32], detxxt[64], detxtxt[64];
  int xlen, xxlen, xtlen, xxtlen, xtxtlen;
  REAL_tetgen_t x1[128], x2[192];
  int x1len, x2len;
  REAL_tetgen_t dety[32], detyy[64], detyt[32], detyyt[64], detytyt[64];
  int ylen, yylen, ytlen, yytlen, ytytlen;
  REAL_tetgen_t y1[128], y2[192];
  int y1len, y2len;
  REAL_tetgen_t adet[384], bdet[384], cdet[384], abdet[768], deter[1152];
...
REAL_tetgen_t incircleadapt(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t permanent)
{
  INEXACT REAL_tetgen_t adx, bdx, cdx, ady, bdy, cdy;
  REAL_tetgen_t det, errbound;
  ...
  REAL_tetgen_t bc[4], ca[4], ab[4];
  INEXACT REAL_tetgen_t bc3, ca3, ab3;
  REAL_tetgen_t axbc[8], axxbc[16], aybc[8], ayybc[16], adet[32];
  int axbclen, axxbclen, aybclen, ayybclen, alen;
  REAL_tetgen_t bxca[8], bxxca[16], byca[8], byyca[16], bdet[32];
  int bxcalen, bxxcalen, bycalen, byycalen, blen;
  REAL_tetgen_t cxab[8], cxxab[16], cyab[8], cyyab[16], cdet[32];
  int cxablen, cxxablen, cyablen, cyyablen, clen;
  REAL_tetgen_t abdet[64];
  int ablen;
  REAL_tetgen_t fin1[1152], fin2[1152];
  REAL_tetgen_t *finnow, *finother, *finswap;
  int finlength;

  REAL_tetgen_t adxtail, bdxtail, cdxtail, adytail, bdytail, cdytail;
  INEXACT REAL_tetgen_t adxadx1, adyady1, bdxbdx1, bdybdy1, cdxcdx1, cdycdy1;
  REAL_tetgen_t adxadx0, adyady0, bdxbdx0, bdybdy0, cdxcdx0, cdycdy0;
  REAL_tetgen_t aa[4], bb[4], cc[4];
  INEXACT REAL_tetgen_t aa3, bb3, cc3;
  INEXACT REAL_tetgen_t ti1, tj1;
  REAL_tetgen_t ti0, tj0;
  REAL_tetgen_t u[4], v[4];
  INEXACT REAL_tetgen_t u3, v3;
  REAL_tetgen_t temp8[8], temp16a[16], temp16b[16], temp16c[16];
  REAL_tetgen_t temp32a[32], temp32b[32], temp48[48], temp64[64];
  int temp8len, temp16alen, temp16blen, temp16clen;
  int temp32alen, temp32blen, temp48len, temp64len;
  REAL_tetgen_t axtbb[8], axtcc[8], aytbb[8], aytcc[8];
  int axtbblen, axtcclen, aytbblen, aytcclen;
  REAL_tetgen_t bxtaa[8], bxtcc[8], bytaa[8], bytcc[8];
  int bxtaalen, bxtcclen, bytaalen, bytcclen;
  REAL_tetgen_t cxtaa[8], cxtbb[8], cytaa[8], cytbb[8];
  int cxtaalen, cxtbblen, cytaalen, cytbblen;
  REAL_tetgen_t axtbc[8], aytbc[8], bxtca[8], bytca[8], cxtab[8], cytab[8];
  int axtbclen, aytbclen, bxtcalen, bytcalen, cxtablen, cytablen;
  REAL_tetgen_t axtbct[16], aytbct[16], bxtcat[16], bytcat[16], cxtabt[16], cytabt[16];
  int axtbctlen, aytbctlen, bxtcatlen, bytcatlen, cxtabtlen, cytabtlen;
  REAL_tetgen_t axtbctt[8], aytbctt[8], bxtcatt[8];
  REAL_tetgen_t bytcatt[8], cxtabtt[8], cytabtt[8];
  int axtbcttlen, aytbcttlen, bxtcattlen, bytcattlen, cxtabttlen, cytabttlen;
  REAL_tetgen_t abt[8], bct[8], cat[8];
  int abtlen, bctlen, catlen;
  REAL_tetgen_t abtt[4], bctt[4], catt[4];
  int abttlen, bcttlen, cattlen;
  INEXACT REAL_tetgen_t abtt3, bctt3, catt3;
  REAL_tetgen_t negate;
...
REAL_tetgen_t incircle(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd)
{
  REAL_tetgen_t adx, bdx, cdx, ady, bdy, cdy;
  REAL_tetgen_t bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
  REAL_tetgen_t alift, blift, clift;
  REAL_tetgen_t det;
  REAL_tetgen_t permanent, errbound;
...
REAL_tetgen_t inspherefast(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe)
{
  REAL_tetgen_t aex, bex, cex, dex;
  REAL_tetgen_t aey, bey, cey, dey;
  REAL_tetgen_t aez, bez, cez, dez;
  REAL_tetgen_t alift, blift, clift, dlift;
  REAL_tetgen_t ab, bc, cd, da, ac, bd;
  REAL_tetgen_t abc, bcd, cda, dab;
...
REAL_tetgen_t insphereexact(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe)
{
  INEXACT REAL_tetgen_t axby1, bxcy1, cxdy1, dxey1, exay1;
  INEXACT REAL_tetgen_t bxay1, cxby1, dxcy1, exdy1, axey1;
  INEXACT REAL_tetgen_t axcy1, bxdy1, cxey1, dxay1, exby1;
  INEXACT REAL_tetgen_t cxay1, dxby1, excy1, axdy1, bxey1;
  REAL_tetgen_t axby0, bxcy0, cxdy0, dxey0, exay0;
  REAL_tetgen_t bxay0, cxby0, dxcy0, exdy0, axey0;
  REAL_tetgen_t axcy0, bxdy0, cxey0, dxay0, exby0;
  REAL_tetgen_t cxay0, dxby0, excy0, axdy0, bxey0;
  REAL_tetgen_t ab[4], bc[4], cd[4], de[4], ea[4];
  REAL_tetgen_t ac[4], bd[4], ce[4], da[4], eb[4];
  REAL_tetgen_t temp8a[8], temp8b[8], temp16[16];
  int temp8alen, temp8blen, temp16len;
  REAL_tetgen_t abc[24], bcd[24], cde[24], dea[24], eab[24];
  REAL_tetgen_t abd[24], bce[24], cda[24], deb[24], eac[24];
  int abclen, bcdlen, cdelen, dealen, eablen;
  int abdlen, bcelen, cdalen, deblen, eaclen;
  REAL_tetgen_t temp48a[48], temp48b[48];
  int temp48alen, temp48blen;
  REAL_tetgen_t abcd[96], bcde[96], cdea[96], deab[96], eabc[96];
  int abcdlen, bcdelen, cdealen, deablen, eabclen;
  REAL_tetgen_t temp192[192];
  REAL_tetgen_t det384x[384], det384y[384], det384z[384];
  int xlen, ylen, zlen;
  REAL_tetgen_t detxy[768];
  int xylen;
  REAL_tetgen_t adet[1152], bdet[1152], cdet[1152], ddet[1152], edet[1152];
  int alen, blen, clen, dlen, elen;
  REAL_tetgen_t abdet[2304], cddet[2304], cdedet[3456];
  int ablen, cdlen;
  REAL_tetgen_t deter[5760];
  int deterlen;
  int i;
...
REAL_tetgen_t insphereslow(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe)
{
  INEXACT REAL_tetgen_t aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
  REAL_tetgen_t aextail, bextail, cextail, dextail;
  REAL_tetgen_t aeytail, beytail, ceytail, deytail;
  REAL_tetgen_t aeztail, beztail, ceztail, deztail;
  REAL_tetgen_t negate, negatetail;
  INEXACT REAL_tetgen_t axby7, bxcy7, cxdy7, dxay7, axcy7, bxdy7;
  INEXACT REAL_tetgen_t bxay7, cxby7, dxcy7, axdy7, cxay7, dxby7;
  REAL_tetgen_t axby[8], bxcy[8], cxdy[8], dxay[8], axcy[8], bxdy[8];
  REAL_tetgen_t bxay[8], cxby[8], dxcy[8], axdy[8], cxay[8], dxby[8];
  REAL_tetgen_t ab[16], bc[16], cd[16], da[16], ac[16], bd[16];
  int ablen, bclen, cdlen, dalen, aclen, bdlen;
  REAL_tetgen_t temp32a[32], temp32b[32], temp64a[64], temp64b[64], temp64c[64];
  int temp32alen, temp32blen, temp64alen, temp64blen, temp64clen;
  REAL_tetgen_t temp128[128], temp192[192];
  int temp128len, temp192len;
  REAL_tetgen_t detx[384], detxx[768], detxt[384], detxxt[768], detxtxt[768];
  int xlen, xxlen, xtlen, xxtlen, xtxtlen;
  REAL_tetgen_t x1[1536], x2[2304];
  int x1len, x2len;
  REAL_tetgen_t dety[384], detyy[768], detyt[384], detyyt[768], detytyt[768];
  int ylen, yylen, ytlen, yytlen, ytytlen;
  REAL_tetgen_t y1[1536], y2[2304];
  int y1len, y2len;
  REAL_tetgen_t detz[384], detzz[768], detzt[384], detzzt[768], detztzt[768];
  int zlen, zzlen, ztlen, zztlen, ztztlen;
  REAL_tetgen_t z1[1536], z2[2304];
  int z1len, z2len;
  REAL_tetgen_t detxy[4608];
  int xylen;
  REAL_tetgen_t adet[6912], bdet[6912], cdet[6912], ddet[6912];
  int alen, blen, clen, dlen;
  REAL_tetgen_t abdet[13824], cddet[13824], deter[27648];
  int deterlen;
  int i;
...
REAL_tetgen_t insphereadapt(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe,
                   REAL_tetgen_t permanent)
{
  INEXACT REAL_tetgen_t aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
  REAL_tetgen_t det, errbound;

  INEXACT REAL_tetgen_t aexbey1, bexaey1, bexcey1, cexbey1;
  INEXACT REAL_tetgen_t cexdey1, dexcey1, dexaey1, aexdey1;
  INEXACT REAL_tetgen_t aexcey1, cexaey1, bexdey1, dexbey1;
  REAL_tetgen_t aexbey0, bexaey0, bexcey0, cexbey0;
  REAL_tetgen_t cexdey0, dexcey0, dexaey0, aexdey0;
  REAL_tetgen_t aexcey0, cexaey0, bexdey0, dexbey0;
  REAL_tetgen_t ab[4], bc[4], cd[4], da[4], ac[4], bd[4];
  INEXACT REAL_tetgen_t ab3, bc3, cd3, da3, ac3, bd3;
  REAL_tetgen_t abeps, bceps, cdeps, daeps, aceps, bdeps;
  REAL_tetgen_t temp8a[8], temp8b[8], temp8c[8], temp16[16], temp24[24], temp48[48];
  int temp8alen, temp8blen, temp8clen, temp16len, temp24len, temp48len;
  REAL_tetgen_t xdet[96], ydet[96], zdet[96], xydet[192];
  int xlen, ylen, zlen, xylen;
  REAL_tetgen_t adet[288], bdet[288], cdet[288], ddet[288];
  int alen, blen, clen, dlen;
  REAL_tetgen_t abdet[576], cddet[576];
  int ablen, cdlen;
  REAL_tetgen_t fin1[1152];
  int finlength;
  ...
  aex = (REAL_tetgen_t) (pa[0] - pe[0]);
  bex = (REAL_tetgen_t) (pb[0] - pe[0]);
  cex = (REAL_tetgen_t) (pc[0] - pe[0]);
  dex = (REAL_tetgen_t) (pd[0] - pe[0]);
  aey = (REAL_tetgen_t) (pa[1] - pe[1]);
  bey = (REAL_tetgen_t) (pb[1] - pe[1]);
  cey = (REAL_tetgen_t) (pc[1] - pe[1]);
  dey = (REAL_tetgen_t) (pd[1] - pe[1]);
  aez = (REAL_tetgen_t) (pa[2] - pe[2]);
  bez = (REAL_tetgen_t) (pb[2] - pe[2]);
  cez = (REAL_tetgen_t) (pc[2] - pe[2]);
  dez = (REAL_tetgen_t) (pd[2] - pe[2]);
...
REAL_tetgen_t insphere(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe)
{
  return (REAL_tetgen_t)
...
REAL_tetgen_t insphere(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe)
{
  ...
  REAL_tetgen_t aey, bey, cey, dey;
  REAL_tetgen_t aez, bez, cez, dez;
  REAL_tetgen_t aexbey, bexaey, bexcey, cexbey, cexdey, dexcey, dexaey, aexdey;
  REAL_tetgen_t aexcey, cexaey, bexdey, dexbey;
  REAL_tetgen_t alift, blift, clift, dlift;
  REAL_tetgen_t ab, bc, cd, da, ac, bd;
  REAL_tetgen_t abc, bcd, cda, dab;
  REAL_tetgen_t det;
  ...
  REAL_tetgen_t aezplus, bezplus, cezplus, dezplus;
  REAL_tetgen_t aexbeyplus, bexaeyplus, bexceyplus, cexbeyplus;
  REAL_tetgen_t cexdeyplus, dexceyplus, dexaeyplus, aexdeyplus;
  REAL_tetgen_t aexceyplus, cexaeyplus, bexdeyplus, dexbeyplus;
  REAL_tetgen_t permanent, errbound;
...
REAL_tetgen_t orient4dexact(REAL_tetgen_t* pa, REAL_tetgen_t* pb, REAL_tetgen_t* pc, REAL_tetgen_t* pd, REAL_tetgen_t* pe,
                   REAL_tetgen_t aheight, REAL_tetgen_t bheight, REAL_tetgen_t cheight, REAL_tetgen_t dheight, 
                   REAL_tetgen_t eheight)
{
  INEXACT REAL_tetgen_t axby1, bxcy1, cxdy1, dxey1, exay1;
  INEXACT REAL_tetgen_t bxay1, cxby1, dxcy1, exdy1, axey1;
  INEXACT REAL_tetgen_t axcy1, bxdy1, cxey1, dxay1, exby1;
  ...
  REAL_tetgen_t abcd[96], bcde[96], cdea[96], deab[96], eabc[96];
  int abcdlen, bcdelen, cdealen, deablen, eabclen;
  REAL_tetgen_t adet[192], bdet[192], cdet[192], ddet[192], edet[192];
  int alen, blen, clen, dlen, elen;
  REAL_tetgen_t abdet[384], cddet[384], cdedet[576];
  int ablen, cdlen;
  REAL_tetgen_t deter[960];
  int deterlen;
  int i;
...
REAL_tetgen_t orient4dadapt(REAL_tetgen_t* pa, REAL_tetgen_t* pb, REAL_tetgen_t* pc, REAL_tetgen_t* pd, REAL_tetgen_t* pe,
                   REAL_tetgen_t aheight, REAL_tetgen_t bheight, REAL_tetgen_t cheight, REAL_tetgen_t dheight, 
                   REAL_tetgen_t eheight, REAL_tetgen_t permanent)
{
  INEXACT REAL_tetgen_t aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
  INEXACT REAL_tetgen_t aeheight, beheight, ceheight, deheight;
  REAL_tetgen_t det, errbound;
  ...
  INEXACT REAL_tetgen_t ab3, bc3, cd3, da3, ac3, bd3;
  REAL_tetgen_t abeps, bceps, cdeps, daeps, aceps, bdeps;
  REAL_tetgen_t temp8a[8], temp8b[8], temp8c[8], temp16[16], temp24[24];
  int temp8alen, temp8blen, temp8clen, temp16len, temp24len;
  REAL_tetgen_t adet[48], bdet[48], cdet[48], ddet[48];
  int alen, blen, clen, dlen;
  REAL_tetgen_t abdet[96], cddet[96];
  int ablen, cdlen;
  REAL_tetgen_t fin1[192];
  int finlength;

  REAL_tetgen_t aextail, bextail, cextail, dextail;
  REAL_tetgen_t aeytail, beytail, ceytail, deytail;
  REAL_tetgen_t aeztail, beztail, ceztail, deztail;
  REAL_tetgen_t aeheighttail, beheighttail, ceheighttail, deheighttail;
  ...
  cez = (REAL_tetgen_t) (pc[2] - pe[2]);
  dez = (REAL_tetgen_t) (pd[2] - pe[2]);
  aeheight = (REAL_tetgen_t) (aheight - eheight);
  beheight = (REAL_tetgen_t) (bheight - eheight);
  ceheight = (REAL_tetgen_t) (cheight - eheight);
  deheight = (REAL_tetgen_t) (dheight - eheight);
...
REAL_tetgen_t orient4d(REAL_tetgen_t* pa, REAL_tetgen_t* pb, REAL_tetgen_t* pc, REAL_tetgen_t* pd, REAL_tetgen_t* pe, 
              REAL_tetgen_t aheight, REAL_tetgen_t bheight, REAL_tetgen_t cheight, REAL_tetgen_t dheight, 
              REAL_tetgen_t eheight)
{
 REAL_tetgen_t aex, bex, cex, dex;
 ...
 REAL_tetgen_t aexbey, bexaey, bexcey, cexbey, cexdey, dexcey, dexaey, aexdey;
 REAL_tetgen_t aexcey, cexaey, bexdey, dexbey;
 REAL_tetgen_t aeheight, beheight, ceheight, deheight;
 REAL_tetgen_t ab, bc, cd, da, ac, bd;
 REAL_tetgen_t abc, bcd, cda, dab;
 REAL_tetgen_t aezplus, bezplus, cezplus, dezplus;
 REAL_tetgen_t aexbeyplus, bexaeyplus, bexceyplus, cexbeyplus;
