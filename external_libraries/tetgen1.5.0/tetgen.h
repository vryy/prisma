...
#define REAL_tetgen_t double  // #define REAL_tetgen_t float
...
public:
  ...
  typedef REAL_tetgen_t (* GetVertexParamOnEdge)(void*, int, int);
  typedef void (* GetSteinerOnEdge)(void*, int, REAL_tetgen_t, REAL_tetgen_t*);
  typedef void (* GetVertexParamOnFace)(void*, int, int, REAL_tetgen_t*);
  typedef void (* GetEdgeSteinerParamOnFace)(void*, int, REAL_tetgen_t, int, REAL_tetgen_t*);
  typedef void (* GetSteinerOnFace)(void*, int, REAL_tetgen_t*, REAL_tetgen_t*);

  // A callback function for mesh refinement.
  typedef bool (* TetSizeFunc)(REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t);
  ...
  REAL_tetgen_t *pointlist;
  REAL_tetgen_t *pointattributelist;
  REAL_tetgen_t *pointmtrlist;
  int  *pointmarkerlist;
  ...
  //   volume; one REAL_tetgen_t per element.  Input only.
  // 'neighborlist':  An array of tetrahedron neighbors; 4 ints per element. 
  //   Output only.
  int  *tetrahedronlist;
  REAL_tetgen_t *tetrahedronattributelist;
  REAL_tetgen_t *tetrahedronvolumelist;
  int  *neighborlist;
  ...
  //   actually an integer.
  REAL_tetgen_t *facetconstraintlist;
  ...
  REAL_tetgen_t *segmentconstraintlist;
  ...
  void initialize()
  {
    ...
    pointlist = (REAL_tetgen_t *) NULL;
    pointattributelist = (REAL_tetgen_t *) NULL;
    pointmtrlist = (REAL_tetgen_t *) NULL;
    ...
    tetrahedronattributelist = (REAL_tetgen_t *) NULL;
    tetrahedronvolumelist = (REAL_tetgen_t *) NULL;
    ...
    holelist = (REAL_tetgen_t *) NULL;
    numberofholes = 0;

    regionlist = (REAL_tetgen_t *) NULL;
    numberofregions = 0;

    facetconstraintlist = (REAL_tetgen_t *) NULL;
    numberoffacetconstraints = 0;
    segmentconstraintlist = (REAL_tetgen_t *) NULL;
    numberofsegmentconstraints = 0;


    vpointlist = (REAL_tetgen_t *) NULL;
  ...
  void deinitialize()
  {
    ...
    if (pointlist != (REAL_tetgen_t *) NULL) {
      delete [] pointlist;
    }
    if (pointattributelist != (REAL_tetgen_t *) NULL) {
      delete [] pointattributelist;
    }
    if (pointmtrlist != (REAL_tetgen_t *) NULL) {
      delete [] pointmtrlist;
    }
    ...
    if (tetrahedronattributelist != (REAL_tetgen_t *) NULL) {
      delete [] tetrahedronattributelist;
    }
    if (tetrahedronvolumelist != (REAL_tetgen_t *) NULL) {
    ...
    if (facetlist != (facet *) NULL) {
      ...
      for (i = 0; i < numberoffacets; i++) {
        ...
        if (f->holelist != (REAL_tetgen_t *) NULL) {
          delete [] f->holelist;
        }
      }
      delete [] facetlist;
    ...
    if (holelist != (REAL_tetgen_t *) NULL) {
      delete [] holelist;
    }
    if (regionlist != (REAL_tetgen_t *) NULL) {
      delete [] regionlist;
    }
    if (facetconstraintlist != (REAL_tetgen_t *) NULL) {
      delete [] facetconstraintlist;
    }
    if (segmentconstraintlist != (REAL_tetgen_t *) NULL) {
      delete [] segmentconstraintlist;
    }
    if (vpointlist != (REAL_tetgen_t *) NULL) {
      delete [] vpointlist;
    }
...
public:
  ...
  REAL_tetgen_t brio_ratio;                                             // '-b/' 0.125.
  REAL_tetgen_t facet_ang_tol;                                          // '-p', 179.9.
  REAL_tetgen_t maxvolume;                                               // '-a', -1.0.
  REAL_tetgen_t minratio;                                                 // '-q', 0.0.
  REAL_tetgen_t mindihedral;                                              // '-q', 5.0.
  REAL_tetgen_t optmaxdihedral;                                               // 165.0.
  REAL_tetgen_t optminsmtdihed;                                               // 179.0.
  REAL_tetgen_t optminslidihed;                                               // 179.0.  
  REAL_tetgen_t epsilon;                                               // '-T', 1.0e-8.
  REAL_tetgen_t minedgelength;                                                  // 0.0.
  REAL_tetgen_t coarsen_percent;                                         // -R1/#, 1.0.
...
void exactinit(int, int, int, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t);
...
REAL_tetgen_t orient4d(REAL_tetgen_t *pa, REAL_tetgen_t *pb, REAL_tetgen_t *pc, REAL_tetgen_t *pd, REAL_tetgen_t *pe,
              REAL_tetgen_t ah, REAL_tetgen_t bh, REAL_tetgen_t ch, REAL_tetgen_t dh, REAL_tetgen_t eh);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  typedef REAL_tetgen_t **tetrahedron;
  ...
  typedef REAL_tetgen_t **shellface;
...
///////////////////////////////////////////////////////////////////////////////
  ...
  public:
    triface tt; 
    face ss;
    REAL_tetgen_t key, cent[6];  // circumcenter or cos(dihedral angles) at 6 edges.
...
///////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    REAL_tetgen_t smlen; // for useinsertradius.
    point parentpt;
...
///////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    REAL_tetgen_t bak_tetprism_vol; // The value to be minimized.
    REAL_tetgen_t tetprism_vol_sum;
    int remove_large_angle; // Remove a large dihedral angle at edge.
    REAL_tetgen_t cosdihed_in; // The input cosine of the dihedral angle (> 0).
    REAL_tetgen_t cosdihed_out; // The improved cosine of the dihedral angle.
...
///////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    REAL_tetgen_t initval, imprval;

    int numofsearchdirs;
    REAL_tetgen_t searchstep;
...
///////////////////////////////////////////////////////////////////////////////
  ...
  // _PI_ is the ratio of a circle's circumference to its diameter.
  static REAL_tetgen_t _PI_;
  ...
  REAL_tetgen_t cosmaxdihed, cosmindihed;    // The cosine values of max/min dihedral.
  REAL_tetgen_t cossmtdihed;     // The cosine value of a bad dihedral to be smoothed.
  REAL_tetgen_t cosslidihed;      // The cosine value of the max dihedral of a sliver.
  REAL_tetgen_t minfaceang, minfacetdihed;     // The minimum input (dihedral) angles.
  REAL_tetgen_t tetprism_vol_sum;   // The total volume of tetrahedral-prisms (in 4D).
  REAL_tetgen_t longest;                          // The longest possible edge length.
  REAL_tetgen_t xmax, xmin, ymax, ymin, zmax, zmin;         // Bounding box of points.
...
///////////////////////////////////////////////////////////////////////////////
  ...
  inline REAL_tetgen_t elemattribute(tetrahedron* ptr, int attnum);
  inline void setelemattribute(tetrahedron* ptr, int attnum, REAL_tetgen_t value);
  inline REAL_tetgen_t volumebound(tetrahedron* ptr);
  inline void setvolumebound(tetrahedron* ptr, REAL_tetgen_t value);
  ...
  inline REAL_tetgen_t areabound(face& s);
  inline void setareabound(face& s, REAL_tetgen_t value);
  ...
  inline REAL_tetgen_t pointgeomuv(point pt, int i);
  inline void setpointgeomuv(point pt, int i, REAL_tetgen_t value);
  ...
  inline void setpointinsradius(point pt, REAL_tetgen_t value);
  inline REAL_tetgen_t getpointinsradius(point pt);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  REAL_tetgen_t insphere_s(REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*);
  REAL_tetgen_t orient4d_s(REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, 
                  REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t);

  // Triangle-edge intersection test (robust)
  int tri_edge_2d(point, point, point, point, point, point, int, int*, int*);
  int tri_edge_tail(point, point, point, point, point, point, REAL_tetgen_t, REAL_tetgen_t, int,
                    int*, int*);
  int tri_edge_test(point, point, point, point, point, point, int, int*, int*);

  // Triangle-triangle intersection test (robust)
  int tri_edge_inter_tail(point, point, point, point, point, REAL_tetgen_t, REAL_tetgen_t);
  int tri_tri_inter(point, point, point, point, point, point);

  // Linear algebra functions
  inline REAL_tetgen_t dot(REAL_tetgen_t* v1, REAL_tetgen_t* v2);
  inline void cross(REAL_tetgen_t* v1, REAL_tetgen_t* v2, REAL_tetgen_t* n);
  bool lu_decmp(REAL_tetgen_t lu[4][4], int n, int* ps, REAL_tetgen_t* d, int N);
  void lu_solve(REAL_tetgen_t lu[4][4], int n, int* ps, REAL_tetgen_t* b, int N);

  // An embedded 2-dimensional geometric predicate (non-robust)
  REAL_tetgen_t incircle3d(point pa, point pb, point pc, point pd);
  ...
  inline REAL_tetgen_t norm2(REAL_tetgen_t x, REAL_tetgen_t y, REAL_tetgen_t z);
  inline REAL_tetgen_t distance(REAL_tetgen_t* p1, REAL_tetgen_t* p2);
  void facenormal(point pa, point pb, point pc, REAL_tetgen_t *n, int pivot, REAL_tetgen_t *lav);
  REAL_tetgen_t shortdistance(REAL_tetgen_t* p, REAL_tetgen_t* e1, REAL_tetgen_t* e2);
  REAL_tetgen_t triarea(REAL_tetgen_t* pa, REAL_tetgen_t* pb, REAL_tetgen_t* pc);
  REAL_tetgen_t interiorangle(REAL_tetgen_t* o, REAL_tetgen_t* p1, REAL_tetgen_t* p2, REAL_tetgen_t* n);
  void projpt2edge(REAL_tetgen_t* p, REAL_tetgen_t* e1, REAL_tetgen_t* e2, REAL_tetgen_t* prj);
  void projpt2face(REAL_tetgen_t* p, REAL_tetgen_t* f1, REAL_tetgen_t* f2, REAL_tetgen_t* f3, REAL_tetgen_t* prj);
  REAL_tetgen_t facedihedral(REAL_tetgen_t* pa, REAL_tetgen_t* pb, REAL_tetgen_t* pc1, REAL_tetgen_t* pc2);
  bool tetalldihedral(point, point, point, point, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*);
  void tetallnormal(point, point, point, point, REAL_tetgen_t N[4][3], REAL_tetgen_t* volume);
  REAL_tetgen_t tetaspectratio(point, point, point, point);
  bool circumsphere(REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t* cent, REAL_tetgen_t* radius);
  bool orthosphere(REAL_tetgen_t*,REAL_tetgen_t*,REAL_tetgen_t*,REAL_tetgen_t*,REAL_tetgen_t,REAL_tetgen_t,REAL_tetgen_t,REAL_tetgen_t,REAL_tetgen_t*,REAL_tetgen_t*);
  void planelineint(REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*);
  int linelineint(REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*, REAL_tetgen_t*);
  REAL_tetgen_t tetprismvol(REAL_tetgen_t* pa, REAL_tetgen_t* pb, REAL_tetgen_t* pc, REAL_tetgen_t* pd);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  int  hilbert_split(point* vertexarray, int arraysize, int gc0, int gc1,
                     REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t);
  void hilbert_sort3(point* vertexarray, int arraysize, int e, int d,
                     REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, int depth);
  void brio_multiscale_sort(point*,int,int threshold,REAL_tetgen_t ratio,int* depth);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  void scarveholes(int, REAL_tetgen_t*);
  void triangulate(int, arraypool*, arraypool*, int, REAL_tetgen_t*);
  ...
  void interecursive(shellface** subfacearray, int arraysize, int axis,
                     REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, REAL_tetgen_t, int* internum);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  REAL_tetgen_t getpointmeshsize(point, triface*, int iloc);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  int splitsegment(face *splitseg, point encpt, REAL_tetgen_t, point, point, int, int);
  void repairencsegs(int chkencflag);

  void enqueuesubface(memorypool*, face*);
  int checkfac4encroach(point, point, point, point checkpt, REAL_tetgen_t*, REAL_tetgen_t*);
  int checkfac4split(face *chkfac, point& encpt, int& qflag, REAL_tetgen_t *ccent);
  int splitsubface(face *splitfac, point, point, int qflag, REAL_tetgen_t *ccent, int);
  void repairencfacs(int chkencflag);

  void enqueuetetrahedron(triface*);
  int checktet4split(triface *chktet, int& qflag, REAL_tetgen_t *ccent);
  int splittetrahedron(triface* splittet,int qflag,REAL_tetgen_t *ccent, int);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  int  splitsliver(triface *, REAL_tetgen_t, int);
...
inline REAL_tetgen_t tetgenmesh::elemattribute(tetrahedron* ptr, int attnum) {
  return ((REAL_tetgen_t *) (ptr))[elemattribindex + attnum];
}

inline void tetgenmesh::setelemattribute(tetrahedron* ptr, int attnum, 
  REAL_tetgen_t value) {
  ((REAL_tetgen_t *) (ptr))[elemattribindex + attnum] = value;
}

// Check or set a tetrahedron's maximum volume bound.

inline REAL_tetgen_t tetgenmesh::volumebound(tetrahedron* ptr) {
  return ((REAL_tetgen_t *) (ptr))[volumeboundindex];
}

inline void tetgenmesh::setvolumebound(tetrahedron* ptr, REAL_tetgen_t value) {
  ((REAL_tetgen_t *) (ptr))[volumeboundindex] = value;
}
...
inline REAL_tetgen_t tetgenmesh::areabound(face& s) 
{
  return ((REAL_tetgen_t *) (s.sh))[areaboundindex];
}

inline void tetgenmesh::setareabound(face& s, REAL_tetgen_t value) 
{
  ((REAL_tetgen_t *) (s.sh))[areaboundindex] = value;
}
...
inline REAL_tetgen_t tetgenmesh::pointgeomuv(point pt, int i) {
  return pt[pointparamindex + i];
}

inline void tetgenmesh::setpointgeomuv(point pt, int i, REAL_tetgen_t value) {
...
inline void tetgenmesh::setpointinsradius(point pt, REAL_tetgen_t value)
{
  pt[pointmtrindex + sizeoftensor - 1] = value;
}

inline REAL_tetgen_t tetgenmesh::getpointinsradius(point pt)
{
...
inline REAL_tetgen_t tetgenmesh::dot(REAL_tetgen_t* v1, REAL_tetgen_t* v2) 
{
  return v1[0] * v2[0] + v1[1] * v2[1] + v1[2] * v2[2];
}

// cross() computes the cross product: n = v1 cross v2.
inline void tetgenmesh::cross(REAL_tetgen_t* v1, REAL_tetgen_t* v2, REAL_tetgen_t* n) 
{
...
inline REAL_tetgen_t tetgenmesh::distance(REAL_tetgen_t* p1, REAL_tetgen_t* p2)
{
...
inline REAL_tetgen_t tetgenmesh::norm2(REAL_tetgen_t x, REAL_tetgen_t y, REAL_tetgen_t z)
{
  return (x) * (x) + (y) * (y) + (z) * (z);
}
