...
namespace Kratos
{
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLID_TEMPERATURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( FLUID_TEMPERATURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( AVERAGE_TEMPERATURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( INLET_TEMPERATURE)
//     KRATOS_CREATE_DOUBLE_VARIABLE( AMBIENT_TEMPERATURE )
//     KRATOS_CREATE_DOUBLE_VARIABLE( Y_WALL)
    KRATOS_CREATE_DOUBLE_VARIABLE( COUNTER )
    KRATOS_CREATE_DOUBLE_VARIABLE( DISTANCE_CORRECTION )
    KRATOS_CREATE_DOUBLE_VARIABLE( COMPUTED_DISTANCE )
    KRATOS_CREATE_DOUBLE_VARIABLE( MATERIAL )

    KRATOS_CREATE_DOUBLE_VARIABLE( LAST_AIR )
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESSURES )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURES )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( VELOCITIES )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLIDFRACTION )
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLIDIF_TIME )
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLIDIF_MODULUS )
    KRATOS_CREATE_DOUBLE_VARIABLE( FILLTIME )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( SHRINKAGE_POROSITY )
    KRATOS_CREATE_DOUBLE_VARIABLE( MAX_VEL )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( SHRINKAGE_POROSITY_US )
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLIDIF_MODULUS_US )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURES_US )
    KRATOS_CREATE_DOUBLE_VARIABLE( FRONT_MEETING )
