...
//    KRATOS_CREATE_VARIABLE( double, TEMPERATURE_OLD_IT )
    ...
    KRATOS_CREATE_VARIABLE( double, DENSITY_DT )
    KRATOS_CREATE_VARIABLE( double, DENSITY_ACCELERATION )
    KRATOS_CREATE_VARIABLE( double, DENSITY_NULL )
    KRATOS_CREATE_VARIABLE( double, DENSITY_NULL_DT )
    KRATOS_CREATE_VARIABLE( double, DENSITY_NULL_ACCELERATION )
    KRATOS_CREATE_VARIABLE( double, DENSITY_EINS )
    KRATOS_CREATE_VARIABLE( double, DENSITY_EINS_DT )
    KRATOS_CREATE_VARIABLE( double, DENSITY_EINS_ACCELERATION )
...
//    KRATOS_CREATE_VARIABLE( double, IS_VISITED )
    ...
    KRATOS_CREATE_VARIABLE( double, NEWMARK_ALPHAF )
    KRATOS_CREATE_VARIABLE( double, NEWMARK_ALPHAM )
