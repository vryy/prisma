...
namespace Kratos
{
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_OLD )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_NULL )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_EINS )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_NULL_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_EINS_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_DT2 )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_NULL_DT2 )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAMBDA_EINS_DT2 )
    ...
    KRATOS_CREATE_MATRIX_VARIABLE( STRAIN_INTERPOLATION_OPERATOR )
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ACCELERATION_OLD )
...
//    KRATOS_CREATE_VARIABLE( int, QUASI_STATIC_ANALYSIS )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( INTEGRATION_WEIGHT )
...
//    KRATOS_CREATE_DOUBLE_VARIABLE( NODAL_VOLUME )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESSURE_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESSURE_ACCELERATION )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( REACTION_LAGRANGE_WATER_PRESSURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESCRIBED_DELTA_WATER_PRESSURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESCRIBED_WATER_PRESSURE )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( REACTION_LAGRANGE_AIR_PRESSURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESCRIBED_DELTA_AIR_PRESSURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( PRESCRIBED_AIR_PRESSURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( SUCTION )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( AIR_FLOW )
//    KRATOS_CREATE_DOUBLE_VARIABLE( FLAG_VARIABLE )

    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_DT2 )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_NULL )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_NULL_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_NULL_DT2 )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_EINS )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_EINS_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( SATURATION_EINS_DT2 )
...
//    KRATOS_CREATE_DOUBLE_VARIABLE( RHS_AIR )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( PERMEABILITY_28_DAYS )
    KRATOS_CREATE_DOUBLE_VARIABLE( PERMEABILITY_1_DAY )
    KRATOS_CREATE_DOUBLE_VARIABLE( PERMEABILITY_TRANSITION )

    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_ACCELERATION )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_NULL )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_NULL_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_NULL_ACCELERATION )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_EINS )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_EINS_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_EINS_ACCELERATION )
//    KRATOS_CREATE_DOUBLE_VARIABLE( TEMPERATURE_OLD_IT )

    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_ACCELERATION )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_NULL )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_NULL_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_NULL_ACCELERATION )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_EINS )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_EINS_DT )
    KRATOS_CREATE_DOUBLE_VARIABLE( DENSITY_EINS_ACCELERATION )
...
//    KRATOS_CREATE_DOUBLE_VARIABLE( IS_BOUNDARY )
//    KRATOS_CREATE_DOUBLE_VARIABLE( IS_VISITED )

    KRATOS_CREATE_DOUBLE_VARIABLE( LAGRANGE_MULTIPLIER_CONSTRAINT )
    KRATOS_CREATE_DOUBLE_VARIABLE( LAGRANGE_MULTIPLIER_CONSTRAINT_REACTION )

    KRATOS_CREATE_VARIABLE( int, IS_SHAPE_FUNCTION_REQUIRED )
    KRATOS_CREATE_VARIABLE( int, RESET_CONFIGURATION )
    KRATOS_CREATE_VECTOR_VARIABLE( SHAPE_FUNCTION_VALUES )
    KRATOS_CREATE_MATRIX_VARIABLE( SHAPE_FUNCTION_DERIVATIVES )

    KRATOS_CREATE_VARIABLE( RealNode::Pointer, ASSOCIATED_NODE )
    ...
    KRATOS_CREATE_VARIABLE( int, TIME_INTEGRATION_SCHEME )
    KRATOS_CREATE_DOUBLE_VARIABLE( NEWMARK_ALPHAF )
    KRATOS_CREATE_DOUBLE_VARIABLE( NEWMARK_ALPHAM )

    KRATOS_CREATE_DOUBLE_VARIABLE( STRESS_XX )
    KRATOS_CREATE_DOUBLE_VARIABLE( STRESS_YY )
    KRATOS_CREATE_DOUBLE_VARIABLE( STRESS_ZZ )
    KRATOS_CREATE_DOUBLE_VARIABLE( STRESS_XY )
    KRATOS_CREATE_DOUBLE_VARIABLE( STRESS_YZ )
    KRATOS_CREATE_DOUBLE_VARIABLE( STRESS_XZ )

    KRATOS_CREATE_VARIABLE( int, POROSITY_CALCULATION_MODE )
    ...
    void KratosApplication::RegisterLegacyStructuralAppVariables()
    {
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( ACCELERATION_OLD )
...
//        KRATOS_REGISTER_VARIABLE( NODAL_VOLUME )
        ...
        KRATOS_REGISTER_VARIABLE( PRESCRIBED_DELTA_WATER_PRESSURE )
        KRATOS_REGISTER_VARIABLE( PRESCRIBED_WATER_PRESSURE )
        ...
        KRATOS_REGISTER_VARIABLE( PRESCRIBED_DELTA_AIR_PRESSURE )
        KRATOS_REGISTER_VARIABLE( PRESCRIBED_AIR_PRESSURE )
...
//        KRATOS_REGISTER_VARIABLE( FLAG_VARIABLE )
        ...
        KRATOS_REGISTER_VARIABLE( SATURATION_DT )
        KRATOS_REGISTER_VARIABLE( SATURATION_DT2 )
        KRATOS_REGISTER_VARIABLE( SATURATION_NULL )
        KRATOS_REGISTER_VARIABLE( SATURATION_NULL_DT )
        KRATOS_REGISTER_VARIABLE( SATURATION_NULL_DT2 )
        KRATOS_REGISTER_VARIABLE( SATURATION_EINS )
        KRATOS_REGISTER_VARIABLE( SATURATION_EINS_DT )
        KRATOS_REGISTER_VARIABLE( SATURATION_EINS_DT2 )
...
//        KRATOS_REGISTER_VARIABLE( RHS_AIR )
        ...
        KRATOS_REGISTER_VARIABLE( DENSITY_DT )
        KRATOS_REGISTER_VARIABLE( DENSITY_ACCELERATION )
        KRATOS_REGISTER_VARIABLE( DENSITY_NULL )
        KRATOS_REGISTER_VARIABLE( DENSITY_NULL_DT )
        KRATOS_REGISTER_VARIABLE( DENSITY_NULL_ACCELERATION )
        KRATOS_REGISTER_VARIABLE( DENSITY_EINS )
        KRATOS_REGISTER_VARIABLE( DENSITY_EINS_DT )
        KRATOS_REGISTER_VARIABLE( DENSITY_EINS_ACCELERATION )
...
//        KRATOS_REGISTER_VARIABLE( IS_VISITED )
        ...
        KRATOS_REGISTER_VARIABLE( TIME_INTEGRATION_SCHEME )
        KRATOS_REGISTER_VARIABLE( NEWMARK_ALPHAF )
        KRATOS_REGISTER_VARIABLE( NEWMARK_ALPHAM )

        KRATOS_REGISTER_VARIABLE( STRESS_XX )
        KRATOS_REGISTER_VARIABLE( STRESS_YY )
        KRATOS_REGISTER_VARIABLE( STRESS_ZZ )
        KRATOS_REGISTER_VARIABLE( STRESS_XY )
        KRATOS_REGISTER_VARIABLE( STRESS_YZ )
        KRATOS_REGISTER_VARIABLE( STRESS_XZ )

        KRATOS_REGISTER_VARIABLE( POROSITY_CALCULATION_MODE )
