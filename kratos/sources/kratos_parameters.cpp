...
Parameters::iterator_adaptor::iterator_adaptor(Parameters::iterator_adaptor::value_iterator itValue, nlohmann::json* pValue,  boost::shared_ptr<nlohmann::json> pRoot) :mDistance(std::distance(pValue->begin(), itValue)), mrValue(*pValue), mpParameters(new Parameters(itValue, pValue, pRoot)) {}
...
Parameters::const_iterator_adaptor::const_iterator_adaptor(value_iterator itValue, nlohmann::json* pValue,  boost::shared_ptr<nlohmann::json> pRoot) : mDistance(std::distance(pValue->cbegin(), itValue)), mrValue(*pValue), mpParameters(new Parameters(itValue, pValue, pRoot)) {}
...
{
    mpRoot = boost::make_shared<nlohmann::json>(nlohmann::json::parse( "{}", nullptr, true, true));
    mpValue = mpRoot.get();
}
...
{
    mpRoot = boost::make_shared<nlohmann::json>(nlohmann::json::parse( rJsonString, nullptr, true, true));
    mpValue = mpRoot.get();
...
{
    mpRoot = boost::make_shared<nlohmann::json>(nlohmann::json::parse( rStringStream, nullptr, true, true));
    mpValue = mpRoot.get();
...
Parameters& Parameters::operator=(Parameters const& rOther)
{
    if(mpRoot.get() ==  mpValue || mpRoot == nullptr) {
        mpRoot = boost::make_shared<nlohmann::json>(nlohmann::json::parse(rOther.WriteJsonString(), nullptr, true, true));
        mpValue = mpRoot.get();
    } else {
...
Parameters::Parameters(nlohmann::json* pValue, boost::shared_ptr<nlohmann::json> pRoot)
    : mpValue(pValue),
      mpRoot(pRoot)
{}
...
Parameters::Parameters(json_iterator itValue, nlohmann::json* pValue, boost::shared_ptr<nlohmann::json> pRoot)
    : mpValue(nullptr),
        mpRoot(pRoot)
{
...
Parameters::Parameters(json_const_iterator itValue, nlohmann::json* pValue, boost::shared_ptr<nlohmann::json> pRoot)
    : mpValue(nullptr),
        mpRoot(pRoot)
{
...
boost::shared_ptr<nlohmann::json> Parameters::GetUnderlyingRootStorage()
{
    return mpRoot;
}
...
boost::shared_ptr<nlohmann::json> Parameters::GetUnderlyingRootStorage() const
{
    return mpRoot;
}
...
void Parameters::SetUnderlyingRootStorage(boost::shared_ptr<nlohmann::json> pNewValue)
{
    mpRoot = pNewValue;
}
