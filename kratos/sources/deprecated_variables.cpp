...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( bool, IS_INLET )
    KRATOS_CREATE_VARIABLE( bool, IS_INTERFACE )
    KRATOS_CREATE_VARIABLE( bool, IS_VISITED )
    KRATOS_CREATE_VARIABLE( bool, IS_EROSIONABLE )

    KRATOS_CREATE_VARIABLE( bool, IS_STRUCTURE )
    KRATOS_CREATE_VARIABLE( bool, IS_POROUS )
    KRATOS_CREATE_VARIABLE( bool, IS_WATER )
    KRATOS_CREATE_VARIABLE( bool, IS_FLUID )
    KRATOS_CREATE_VARIABLE( bool, IS_BOUNDARY )
    KRATOS_CREATE_VARIABLE( bool, IS_FREE_SURFACE )
    KRATOS_CREATE_VARIABLE( bool, IS_AIR_EXIT )
    KRATOS_CREATE_VARIABLE( bool, IS_LAGRANGIAN_INLET )
    KRATOS_CREATE_VARIABLE( bool, IS_WATER_ELEMENT )


    KRATOS_CREATE_VARIABLE( bool, IS_BURN )
    KRATOS_CREATE_VARIABLE( bool, IS_DRIPPING )
    KRATOS_CREATE_VARIABLE( bool, IS_PERMANENT )
    KRATOS_CREATE_VARIABLE( bool, IS_WALL )
    ...
    KRATOS_CREATE_VARIABLE( bool, IS_SLIP )

    //for Level Set application:
    KRATOS_CREATE_VARIABLE( bool, IS_DIVIDED )
