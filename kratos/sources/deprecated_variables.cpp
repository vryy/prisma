...
namespace Kratos
{
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( IMPOSED_VELOCITY_X_VALUE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IMPOSED_VELOCITY_Y_VALUE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IMPOSED_VELOCITY_Z_VALUE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IMPOSED_ANGULAR_VELOCITY_X_VALUE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IMPOSED_ANGULAR_VELOCITY_Y_VALUE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IMPOSED_ANGULAR_VELOCITY_Z_VALUE )

    KRATOS_CREATE_DOUBLE_VARIABLE( IS_INLET )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_INTERFACE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_VISITED )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_EROSIONABLE )

    KRATOS_CREATE_DOUBLE_VARIABLE( IS_STRUCTURE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_POROUS )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_WATER )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_FLUID )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_BOUNDARY )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_FREE_SURFACE )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_AIR_EXIT )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_LAGRANGIAN_INLET )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_WATER_ELEMENT )


    KRATOS_CREATE_DOUBLE_VARIABLE( IS_BURN )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_DRIPPING )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_PERMANENT )
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_WALL )

    // KRATOS_CREATE_DOUBLE_VARIABLE( Ypr ) //var name does not follow standard
    // KRATOS_CREATE_DOUBLE_VARIABLE( Yox )
    // KRATOS_CREATE_DOUBLE_VARIABLE( Yfuel )
    // KRATOS_CREATE_DOUBLE_VARIABLE( Hfuel )
    // KRATOS_CREATE_DOUBLE_VARIABLE( Hpr )
    // KRATOS_CREATE_DOUBLE_VARIABLE( Hpr1 )
    // KRATOS_CREATE_DOUBLE_VARIABLE( Hox )

    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_1 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_2 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_3 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_4 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_5 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_6 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_7 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_8 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_9 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_10 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_11 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_12 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_13 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_14 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_15 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_16 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_17 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_18 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_19 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_20 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_21 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_22 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_23 )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIATIVE_INTENSITY_24 )

    // KRATOS_CREATE_DOUBLE_VARIABLE( rhoD )
    // KRATOS_CREATE_DOUBLE_VARIABLE( xi )
    // KRATOS_CREATE_DOUBLE_VARIABLE( a )
    // KRATOS_CREATE_DOUBLE_VARIABLE( b )


    KRATOS_CREATE_DOUBLE_VARIABLE( IS_SLIP )

    //for Level Set application:
    KRATOS_CREATE_DOUBLE_VARIABLE( IS_DIVIDED )
