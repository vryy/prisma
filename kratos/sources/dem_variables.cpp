...
namespace Kratos
{
  ...
  //KRATOS_CREATE_DOUBLE_VARIABLE( MOULD_AVERAGE_TEMPERATURE )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( PARTICLE_MASS )
    KRATOS_CREATE_DOUBLE_VARIABLE( RADIUS )
    KRATOS_CREATE_DOUBLE_VARIABLE( SEARCH_TOLERANCE )
    KRATOS_CREATE_DOUBLE_VARIABLE( AMPLIFIED_CONTINUUM_SEARCH_RADIUS_EXTENSION )
    KRATOS_CREATE_DOUBLE_VARIABLE( DEM_DELTA_TIME )
    ...
    KRATOS_CREATE_DOUBLE_VARIABLE( POWER_LAW_TOLERANCE )
    KRATOS_CREATE_DOUBLE_VARIABLE( PARTICLE_SPHERICITY )
    KRATOS_CREATE_DOUBLE_VARIABLE( INIT_DRAG_FORCE )
    KRATOS_CREATE_DOUBLE_VARIABLE( DRAG_LAW_SLOPE )
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLID_FRACTION )
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLID_FRACTION_RATE )
    KRATOS_CREATE_DOUBLE_VARIABLE( FLUID_FRACTION )
    KRATOS_CREATE_DOUBLE_VARIABLE( FLUID_FRACTION_RATE )
    KRATOS_CREATE_DOUBLE_VARIABLE( PHASE_FRACTION )
    KRATOS_CREATE_DOUBLE_VARIABLE( PHASE_FRACTION_RATE )
    KRATOS_CREATE_DOUBLE_VARIABLE( SOLID_FRACTION_PROJECTED )
    KRATOS_CREATE_DOUBLE_VARIABLE( FLUID_FRACTION_PROJECTED )
    KRATOS_CREATE_DOUBLE_VARIABLE( FLUID_DENSITY_PROJECTED )
    KRATOS_CREATE_DOUBLE_VARIABLE( FLUID_VISCOSITY_PROJECTED )
    KRATOS_CREATE_DOUBLE_VARIABLE( REYNOLDS_NUMBER )
    KRATOS_CREATE_DOUBLE_VARIABLE( DRAG_COEFFICIENT )
    KRATOS_CREATE_DOUBLE_VARIABLE( SHEAR_RATE_PROJECTED )
