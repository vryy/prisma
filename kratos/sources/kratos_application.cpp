...
namespace Kratos
{
  ...
  void KratosApplication::RegisterVariables()
  {
      ...
      KRATOS_REGISTER_VARIABLE( BUILD_STATUS )
      ...
      KRATOS_REGISTER_VARIABLE( LOCAL_COORDINATES_SYSTEM )
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( LOCAL_TANGENTIAL_VECTOR_1 )
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( LOCAL_TANGENTIAL_VECTOR_2 )
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( LOCAL_NORMAL_VECTOR )
