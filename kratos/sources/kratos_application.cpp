...
//       KRATOS_REGISTER_VARIABLE( MATERIAL )
      ...
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( COMPLEX_DISPLACEMENT )
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( COMPLEX_REACTION )
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( COMPLEX_VELOCITY )
      KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( COMPLEX_ACCELERATION )
