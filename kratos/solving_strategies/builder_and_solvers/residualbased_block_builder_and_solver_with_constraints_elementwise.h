 ...
 * REMARKS: the ResizeAndInitializeVectors is different than ResidualBasedBlockBuilderAndSolverWithConstraints. One may need to reimplement that (Giang Bui, 9/11/2019)
 */
