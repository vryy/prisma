...
void AddConstraintToPython()
{
    using namespace boost::python;

    class_<MasterSlaveConstraint, MasterSlaveConstraint::Pointer, bases<MasterSlaveConstraint::BaseType, Flags> >
    ("MasterSlaveConstraint", init<>())
    .def(init<int>())
