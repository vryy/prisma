...
#ifdef KRATOS_REGISTER_IN_PYTHON_DOUBLE_VARIABLE
#undef KRATOS_REGISTER_IN_PYTHON_DOUBLE_VARIABLE
#endif
#define KRATOS_REGISTER_IN_PYTHON_DOUBLE_VARIABLE(variable) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(variable)            \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##variable)            \

#ifdef KRATOS_REGISTER_IN_PYTHON_VECTOR_VARIABLE
#undef KRATOS_REGISTER_IN_PYTHON_VECTOR_VARIABLE
#endif
#define KRATOS_REGISTER_IN_PYTHON_VECTOR_VARIABLE(variable) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(variable)            \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##variable)            \

#ifdef KRATOS_REGISTER_IN_PYTHON_MATRIX_VARIABLE
#undef KRATOS_REGISTER_IN_PYTHON_MATRIX_VARIABLE
#endif
#define KRATOS_REGISTER_IN_PYTHON_MATRIX_VARIABLE(variable) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(variable)            \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##variable)            \
...
#define KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(name) \
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##name)     \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##name##_X) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##name##_Y) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(COMPLEX##_##name##_Z) \
