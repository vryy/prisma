...
private:
    ...
    public:
         ...
         */
        iterator_adaptor(value_iterator itValue, nlohmann::json* pValue,  boost::shared_ptr<nlohmann::json> pRoot);
    ...
    public:
         ...
         * @param pRoot The root Parameter pointer
         */
        const_iterator_adaptor(value_iterator itValue, nlohmann::json* pValue,  boost::shared_ptr<nlohmann::json> pRoot);
...
private:
    ...
    boost::shared_ptr<nlohmann::json> mpRoot; /// This is a shared pointer to the root structure (this is what allows us to access in a tree structure to the JSON database)
     ...
     */
    Parameters(nlohmann::json* pValue, boost::shared_ptr<nlohmann::json> pRoot);
     ...
     * @warning Please DO NOT use this constructor. It assumes nlohmann::json and hence it should be considered as an implementation detail
     */
    Parameters(json_iterator itValue, nlohmann::json* pValue, boost::shared_ptr<nlohmann::json> pRoot);
     ...
     * @warning Please DO NOT use this constructor. It assumes nlohmann::json and hence it should be considered as an implementation detail
     */
    Parameters(json_const_iterator itValue, nlohmann::json* pValue, boost::shared_ptr<nlohmann::json> pRoot);
     ...
     * @warning Please DO NOT use this method. It is a low level accessor, and may change in the future
     */
    boost::shared_ptr<nlohmann::json> GetUnderlyingRootStorage();
     ...
     * @warning Please DO NOT use this method. It is a low level accessor, and may change in the future
     */
    boost::shared_ptr<nlohmann::json> GetUnderlyingRootStorage() const;
     ...
     * @warning Please DO NOT use this method. It is a low level accessor, and may change in the future
     */
    void SetUnderlyingRootStorage(boost::shared_ptr<nlohmann::json> pNewValue);
    /**
