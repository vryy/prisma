...
//    KRATOS_DEFINE_DOUBLE_VARIABLE( NODAL_VOLUME )
    ...
    KRATOS_DEFINE_DOUBLE_VARIABLE( PRESCRIBED_DELTA_WATER_PRESSURE )
    KRATOS_DEFINE_DOUBLE_VARIABLE( PRESCRIBED_WATER_PRESSURE )
    ...
    KRATOS_DEFINE_DOUBLE_VARIABLE( PRESCRIBED_DELTA_AIR_PRESSURE )
    KRATOS_DEFINE_DOUBLE_VARIABLE( PRESCRIBED_AIR_PRESSURE )
...
//    KRATOS_DEFINE_DOUBLE_VARIABLE( FLAG_VARIABLE )
    ...
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_DT )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_DT2 )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_NULL )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_NULL_DT )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_NULL_DT2 )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_EINS )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_EINS_DT )
    KRATOS_DEFINE_DOUBLE_VARIABLE( SATURATION_EINS_DT2 )
...
//    KRATOS_DEFINE_DOUBLE_VARIABLE( IS_VISITED )
    ...
    KRATOS_DEFINE_VARIABLE( RealNode::Pointer, ASSOCIATED_NODE )
    ...
    KRATOS_DEFINE_DOUBLE_VARIABLE( STRESS_XX )
    KRATOS_DEFINE_DOUBLE_VARIABLE( STRESS_YY )
    KRATOS_DEFINE_DOUBLE_VARIABLE( STRESS_ZZ )
    KRATOS_DEFINE_DOUBLE_VARIABLE( STRESS_XY )
    KRATOS_DEFINE_DOUBLE_VARIABLE( STRESS_YZ )
    KRATOS_DEFINE_DOUBLE_VARIABLE( STRESS_XZ )

    KRATOS_DEFINE_VARIABLE( int, POROSITY_CALCULATION_MODE )
