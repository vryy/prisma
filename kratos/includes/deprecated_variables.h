...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( bool, IS_INLET )
    KRATOS_DEFINE_VARIABLE( bool, IS_INTERFACE )
    KRATOS_DEFINE_VARIABLE( bool, IS_VISITED )
    KRATOS_DEFINE_VARIABLE( bool, IS_EROSIONABLE )

    KRATOS_DEFINE_VARIABLE( bool, IS_STRUCTURE )
    KRATOS_DEFINE_VARIABLE( bool, IS_POROUS )
    KRATOS_DEFINE_VARIABLE( bool, IS_WATER )
    KRATOS_DEFINE_VARIABLE( bool, IS_FLUID )
    KRATOS_DEFINE_VARIABLE( bool, IS_BOUNDARY )
    KRATOS_DEFINE_VARIABLE( bool, IS_FREE_SURFACE )
    KRATOS_DEFINE_VARIABLE( bool, IS_AIR_EXIT )
    KRATOS_DEFINE_VARIABLE( bool, IS_LAGRANGIAN_INLET )
    KRATOS_DEFINE_VARIABLE( bool, IS_WATER_ELEMENT )


    KRATOS_DEFINE_VARIABLE( bool, IS_BURN )
    KRATOS_DEFINE_VARIABLE( bool, IS_DRIPPING )
    KRATOS_DEFINE_VARIABLE( bool, IS_PERMANENT )
    KRATOS_DEFINE_VARIABLE( bool, IS_WALL )
    ...
    KRATOS_DEFINE_VARIABLE( bool, IS_SLIP )

    //for Level Set application:
    KRATOS_DEFINE_VARIABLE( bool, IS_DIVIDED )
