...
public:
    ...
    /**
     * Returns the data size occupied in the memory of this constitutive law. For an accurate measurement
     * of constitutive law data size in the memory, it is suggested to derive this function in the sub-class.
