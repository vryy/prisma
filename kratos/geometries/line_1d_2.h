...
#if !defined(KRATOS_LINE_1D_2_H_INCLUDED )
#define  KRATOS_LINE_1D_2_H_INCLUDED
...
class Line1D2 : public Geometry<TPointType>
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of Line1D2
    KRATOS_CLASS_POINTER_DEFINITION( Line1D2 );
    ...
    Line1D2( const PointType& FirstPoint, const PointType& SecondPoint )
    ...
    Line1D2( typename PointType::Pointer pFirstPoint, typename PointType::Pointer pSecondPoint )
        : BaseType( PointsArrayType(), &msGeometryData )
    {
    ...
    Line1D2( const PointsArrayType& ThisPoints )
        : BaseType( ThisPoints, &msGeometryData )
    {
        if ( BaseType::PointsNumber() != 2 )
            KRATOS_ERROR << "Invalid points number. Expected 2, given " << BaseType::PointsNumber();
    }
    ...
    */
    ...
    source geometry's points too.
    */
    template<class TOtherPointType> Line1D2( Line1D2<TOtherPointType> const& rOther )
        : BaseType( rOther )
    {
    }
    ...
    {
        return GeometryData::KratosGeometryType::Kratos_Line1D2;
    }
    ...
    @see ClonePoints
    */
    Line1D2& operator=( const Line1D2& rOther )
    {
    ...
    */
    ...
    Line1D2& operator=( Line1D2<TOtherPointType> const & rOther )
    {
        BaseType::operator=( rOther );
    ...
    {
        return typename BaseType::Pointer( new Line1D2( ThisPoints ) );
    }
    ...
    typename Geometry< Point<3, DataType> >::Pointer Clone() const override
    {
        ...
        typename Geometry< Point<3, DataType> >::Pointer p_clone( new Line1D2< Point<3, DataType> >( NewPoints ) );
    ...
    ShapeFunctionsIntegrationPointsGradientsType& ShapeFunctionsIntegrationPointsGradients( ShapeFunctionsIntegrationPointsGradientsType& rResult, IntegrationMethod ThisMethod ) const override
    {
        ...
        // BoundedMatrix<DataType,2,1> DN_DX;

        // DataType detJ = ( BaseType::GetPoint( 1 ).X() - BaseType::GetPoint( 0 ).X() ) * 0.5;
    ...
    {
        return "1 dimensional line in 1D space";
    }

    void PrintInfo( std::ostream& rOStream ) const override
    {
        rOStream << "1 dimensional line in 1D space";
    }
...
private:
    ...
    Line1D2(): BaseType( PointsArrayType(), &msGeometryData ) {}
    ...
    static const ShapeFunctionsValuesContainerType AllShapeFunctionsValues()
    {
        ShapeFunctionsValuesContainerType shape_functions_values = {{
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_GAUSS_1 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_GAUSS_2 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_GAUSS_3 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_GAUSS_4 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_GAUSS_5 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_1 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_2 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_3 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_4 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsValues( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_5 ),
            }
        };
    ...
    static const ShapeFunctionsLocalGradientsContainerType AllShapeFunctionsLocalGradients()
    {
        ShapeFunctionsLocalGradientsContainerType shape_functions_local_gradients = {{
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_GAUSS_1 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_GAUSS_2 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_GAUSS_3 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_GAUSS_4 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_GAUSS_5 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_1 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_2 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_3 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_4 ),
                Line1D2<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_EXTENDED_GAUSS_5 ),
            }
        };
    ...
    template<class TOtherPointType> friend class Line1D2;
...
template<class TPointType>
const GeometryData Line1D2<TPointType>::msGeometryData( 1,
        1,
        1,
        GeometryData::IntegrationMethod::GI_GAUSS_1,
        Line1D2<TPointType>::AllIntegrationPoints(),
        Line1D2<TPointType>::AllShapeFunctionsValues(),
