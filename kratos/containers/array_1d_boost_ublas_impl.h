...
#if !defined(KRATOS_ARRAY_1D_BOOST_UBLAS_IMPL_H_INCLUDED)
#define	 KRATOS_ARRAY_1D_BOOST_UBLAS_IMPL_H_INCLUDED
...
#endif // KRATOS_ARRAY_1D_BOOST_UBLAS_IMPL_H_INCLUDED  defined
